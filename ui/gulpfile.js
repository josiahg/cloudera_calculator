...
gulp.task('build', gulp.parallel('copy-fonts', 'copy-html', 'copy-csv', 'build-sass', 'build-docs-sass', 'build-js', 'build-docs-js'/*, 'copy-docs-js', 'copy-docs-css'*/));
...
gulp.task('watch-csv', () => gulp.watch(csv_src, { ignoreInitial: false }, gulp.series('copy-csv')));
...
gulp.task('watch', gulp.parallel('watch-fonts', 'watch-images', 'watch-html', 'watch-csv', 'watch-sass', 'watch-docs-sass', 'watch-js', 'watch-docs-js'/*, 'watch-docs-js-copy', 'watch-docs-css-copy'*/));
